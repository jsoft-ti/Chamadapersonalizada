package br.com.fabricaapp.chamadapersonalizada.controllers;
...
/**
 * Created by jsoft-ti on 02/03/18.
 */
...
public class AlunoBancoController {
    ...
    public boolean add(Aluno aluno){
        ...
        resultado = db.insert(AlunoBancoHelper.TABELA, null, valores);
        db.close();
    ...
    public Cursor getAll(){
        Cursor cursor;
        String[] campos =  {alunoBancoHelper.ID,alunoBancoHelper.FIELD_NOME,alunoBancoHelper.FIELD_FOTO};
        db = alunoBancoHelper.getReadableDatabase();
        cursor = db.query(alunoBancoHelper.TABELA, campos, null, null, null, null, null, null);
